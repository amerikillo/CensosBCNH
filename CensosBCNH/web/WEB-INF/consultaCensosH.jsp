        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 text-primary">
                    <h2>Consulta de Censos Hospitales</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="http://166.78.128.202:8080/CensosBCNR/consultaJuris.jsp" class="btn btn-default">Censos Jurisdicciones</a>
                    <a href="http://166.78.128.202:8080/CensosBCNR/conEntrevistaJuris.jsp" class="btn btn-default">Entrevistas Jurisdicciones</a>
                    ...
                    <div class="panel-footer">
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="dataTable2">
                            ...
                            <tbody>
                                ...
                                %>
                                <tr class="odd gradeX">
                                    <td><small><%=rset_inv.getString("cla_pro")%></small></td>
                                    <td><small><%=rset_inv.getString("descrip")%></small></td>
                                    <td><small><%=rset_inv.getInt("cant")%></small></td>
                                </tr>
                                <%
                                        }
                                        con.cierraConexion();
