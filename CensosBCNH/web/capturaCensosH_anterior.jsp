        ...
        <div class="container">
            <div class="header">
                <ul class="nav nav-pills pull-right">
                    <li class="active"><a href="indexCap.jsp">Men&uacute;</a></li>
                    ...
                    <table width="1081" border="0">
                        ...
                        <form  method="post" name="form_a" id="form_a" class="form-horizontal" action="GuardaSeccion" >
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="<%=nombreC = nomCam + (contCam += 1)%>" cols="40" maxlength="5" class="form-control" id="<%=nombreC%>" name="<%=nombreC%>" onkeypress="return isNumberKey(event, this);" value="<%=rset.getString(nombreC)%>" />
                                    <%out.print(nombreC);%>    
                                    </label>
                                    </p></td>
                            </tr>
                            <tr>
                                ...
                                <td><input type="text" name="<%=nombreC = nomCam + (contCam += 1)%>" cols="40" maxlength="14" class="form-control" id="<%=nombreC%>" name="<%=nombreC%>" onkeypress="LP_data();
                                        anade(this);
                            ...
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="style58"><span class="style47">
                                            <!--textarea name="<%//=nombreC = nomCam + (contCam += 1)%>" cols="40" class="form-control" id="<%//=nombreC%>" onkeypress="return handleEnter(this, event);" ><%//=rset.getString(nombreC)%></textarea-->
                                            <select class="form-control" name="<%=nombreC = nomCam + (contCam += 1)%>" onkeypress="return handleEnter(this, event);" onchange="servFarmacia();" id="<%=nombreC%>">
                                                <option value="">Seleccione una opción</option>
                                                <option value="SI" <% if (rset.getString(nombreC).equals("SI")) {
                                                        out.println("selected");
                                                    }%> >Si</option>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="<%=nombreC = nomCam + (contCam += 1)%>" cols="40" maxlength="4" class="form-control" id="<%=nombreC%>" name="<%=nombreC%>" onkeypress="return isNumberKey(event, this);" value="<%=rset.getString(nombreC)%>" />
                                        <%out.print(nombreC);%>    
                                        </label>
                                        </p></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="style58">&nbsp;<span class="style47">
                                            <!--textarea name="<%//=nombreC = nomCam + (contCam += 1)%>" cols="40" class="form-control" id="<%//=nombreC%>" onkeypress="return handleEnter(this, event);" ><%//=rset.getString(nombreC)%></textarea-->
                                            <select class="form-control" name="<%=nombreC = nomCam + (contCam += 1)%>" onkeypress="return handleEnter(this, event);" onchange="servAlmacen();" id="<%=nombreC%>">
                                                <option value="">Seleccione una opción</option>
                                                <option value="SI" <% if (rset.getString(nombreC).equals("SI")) {
                                                        out.println("selected");
                                                    }%> >Si</option>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="<%=nombreC = nomCam + (contCam += 1)%>" cols="40" maxlength="3" class="form-control" id="<%=nombreC%>" name="<%=nombreC%>" onkeypress="return isNumberKey(event, this);" value="<%=rset.getString(nombreC)%>" />
                                        <%out.print(nombreC);%>    
                                        </label>
                                        </p></td>
                                </tr> 
                                ...
                                <tr>
                                    ...
                                    <td> 
                                        <label>
                                            <div class="col-sm-6"><input type="text" name="largoRampa" maxlength="4" class="form-control" id="largoRampa" onkeypress="return isNumberKey(event, this);" onkeyup="areaRampa();" value="" /></div>
                                            <div class="col-sm-6"><input type="text" name="anchoRampa" maxlength="4" class="form-control" id="anchoRampa" onkeypress="return isNumberKey(event, this);" onkeyup="areaRampa();" value="" /></div>
                                            <div class="col-sm-12"><input type="text" name="<%=nombreC = nomCam + (contCam += 1)%>" cols="40" maxlength="4" class="form-control" id="<%=nombreC%>" name="<%=nombreC%>" onkeypress="return isNumberKey(event, this);" value="<%=rset.getString(nombreC)%>" readonly /></div>
